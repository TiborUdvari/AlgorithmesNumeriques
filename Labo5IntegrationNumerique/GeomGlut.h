...
class GeomGlut
{
  public:
    ...
    void plot( GLfloat x, GLfloat y, GLfloat sizePoint , float redColor = 0.0f, float greenColor=0.0f, float blueColor=0.0f);

    void segment( GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2 , float redColor = 0.0f, float greenColor=0.0f, float blueColor=0.0f);
